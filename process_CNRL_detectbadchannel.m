function varargout = process_CNRL_detectbadchannel( varargin )
% Brainstorm function modified by Fran López-Caballero (5/5/2021):
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Comment     = 'Detect bad channels: absolute threshold';
    ...
    % Explanations
    sProcess.options.comment1.Comment = ['<BR>  - <B>First column</B>: Signal detection threshold (absolute threshold)<BR>' 10 ...
