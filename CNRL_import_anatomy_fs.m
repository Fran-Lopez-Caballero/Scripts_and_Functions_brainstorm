function errorMsg = CNRL_import_anatomy_fs(iSubject, FsDir, nVertices, isInteractive, sFid, isExtraMaps, isAseg)
% CNRL_IMPORT_ANATOMY_FS: Import a full FreeSurfer folder as the subject's anatomy (importing HCP parcellations as well, CNRL modified).
%
